...
exports.examples = [
        ...
        rightCalloutView: (
          <TouchableOpacity
            ...
            <Image
              ...
              source={{uri: 'https://openclipart.org/image/2400px/svg_to_png/192852/thumbs-up-right.png', width: 25, height: 25}}
            />
          </TouchableOpacity>
        ),
      }}/>;
  ...
  },
  {
    ...
    render() {
      return <AnnotationExample style={styles.map} annotation={{
        title: 'Thumbs Up!',
        image: (uri: 'https://openclipart.org/image/2400px/svg_to_png/192852/thumbs-up-right.png', width: 25, height: 25),
      }}/>;
    }
  },
  {
...
AppRegistry.registerComponent('MapDemoOne', () => MapViewExample);
